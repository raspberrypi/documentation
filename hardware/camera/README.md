...
Full camera legacy-software documentation can be found [here](../../raspbian/applications/camera.md). The newer `libcamera` approach to camera software is documented [here](../../software/libcamera/README.md).
