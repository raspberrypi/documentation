...
1. Connect adapter board and camera to CAM1 port. As an alternative, the Pi Zero camera cable can be used.
...
To attach a standard Raspberry Pi Camera to the Compute Module IO board, a small adaptor board is available. It adapts the 22W FFC to the Pi 15W FFC. As an alternative, the Pi Zero camera cable can be used.
...
1. Attach the 0.5mm 22W FFC flexi (included with the adaptor board) to the CAM1 connector (flex contacts face down). As an alternative, the Pi Zero camera cable can be used.
