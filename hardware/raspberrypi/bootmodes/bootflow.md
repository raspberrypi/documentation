...
* The default pull for the GPIOs is defined on page 102 of the [ARM Peripherals datasheet](/hardware/raspberrypi/bcm2835/BCM2835-ARM-Peripherals.pdf). If the value at boot time does not equal the default pull, then that boot mode is enabled.
