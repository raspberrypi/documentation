...
Some of the content above has been copied from [the elinux SPI page](https://elinux.org/RPi_SPI), which also borrows from here. Both are covered by the CC-SA license.
