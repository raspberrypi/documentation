...
```
Alternatively, use the Raspberry Pi Imager to create a custom SD card from the lastest MSD BETA image on the [releases](https://github.com/raspberrypi/rpi-eeprom/blob/master/releases.md) page.
