...
The Raspberry Pi should work with any SD-compatible cards, although there are some guidelines
...
We recommend buying the Raspberry Pi SD card; this is an 8GB class 6 SD card that outperforms almost all other SD cards on the market and is a good value solution.
