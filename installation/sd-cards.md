...
For installation of Full Raspbian via NOOBS the minimum card size is 16GB. For the image installation of Full Raspbian, the minimum card size is 8GB. For Raspbian Lite image installations we recommend a minimum of 4GB. Some distributions, for example LibreELEC and Arch, can run on much smaller cards. If you're planning to use a card of 64GB or more with NOOBS, see [this page](sdxc_formatting.md) first.
