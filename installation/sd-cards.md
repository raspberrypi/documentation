...
For installation of NOOBS and the full version of Raspbian, the minimum recommended card size is 8GB. For Raspbian Lite image installations we recommend a minimum of 4GB. Some distributions, specifically LibreELEC and Arch, can run on much smaller cards. If using a card 64GB or larger with NOOBS, see [this page](sdxc_formatting.md) first.
