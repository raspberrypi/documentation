...
We recommend most users download [NOOBS](./../noobs), which is designed to be very easy to use. However, more advanced users looking to install a particular image should use this guide.
