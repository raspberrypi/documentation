...
USB boot is available on the Raspberry Pi 3B, 3B+ and Raspberry Pi 2B v1.2 models only. Booting from a USB-attached drive (either a SSD or actual hard drive) can make the Pi boot and work faster. We have extensive instructions on how to do this [here](../hardware/raspberrypi/bootmodes/msd.md).
