...
To update software in Raspbian, you'll need to use the [apt](../../linux/software/apt) tool in a terminal window. Open the terminal from the taskbar or application menu:
