...
To use SSH on your mobile device you need to download a client. There are several good quality clients available, such as [Termius](http://www.termius.com), [Prompt 2](https://panic.com/prompt/), [Cathode](http://www.secretgeometry.com/apps/cathode/) and [Pisth](https://pisth.github.io). 
