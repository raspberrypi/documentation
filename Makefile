...
DOXYGEN_HTML_DIR = documentation/pico-sdk/build/docs/doxygen/html
...
build_doxygen_adoc: 
	@mkdir -p $(ASCIIDOC_DIR)/pico-sdk
	python3 $(SCRIPTS_DIR)/transform_doxygen_html.py $(DOXYGEN_HTML_DIR) $(ASCIIDOC_DIR)/pico-sdk
