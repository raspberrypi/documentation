...
$(ASCIIDOC_DOXYGEN_DIR)/picosdk_index.json $(ASCIIDOC_DOXYGEN_DIR)/index_doxygen.adoc: $(SCRIPTS_DIR)/transform_doxygen_html.py | $(DOXYGEN_HTML_DIR) $(ASCIIDOC_DOXYGEN_DIR)
	$(MAKE) clean_ninja
