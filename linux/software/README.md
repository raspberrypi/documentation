...
- [APT](apt.md)
    - Use `apt install` to install software from the Raspberry Pi OS repository. This has a huge number of software pacakages available. You can use `apt-cache search <search term>` to seach the database for specific software packages. 
- [Python](python.md)
