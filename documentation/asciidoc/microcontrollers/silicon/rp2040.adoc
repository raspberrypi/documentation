...
Designed by Raspberry Pi as both a development board, and as a reference design, the xref:pico-series.adoc[Raspberry Pi Pico 1] is a family of RP2040-based boards.
