...
[.whitepaper, title="Power switching RP2040 for low standby current applications", subtitle="", link=https://pip.raspberrypi.com/documents/RP-004339-WP]
****
...
* Download https://pip.raspberrypi.com/documents/RP-008296-DS[Minimal Viable Board] Design Files (KiCad)
* Download https://pip.raspberrypi.com/documents/RP-008395-DS[VGA Carrier Board] Design Files (KiCad)
...
* Download https://pip.raspberrypi.com/documents/RP-008379-DS[Design Files] for Raspberry Pi Pico (Cadence Allegro)
* Download https://pip.raspberrypi.com/documents/RP-008380-DS[Design Files] for Raspberry Pi Pico W (Cadence Allegro)
...
See Chapter 4, section 4.9.5 of the https://pip.raspberrypi.com/documents/RP-008371-DS[RP2040 Datasheet] for further details of the internal temperature sensor.
