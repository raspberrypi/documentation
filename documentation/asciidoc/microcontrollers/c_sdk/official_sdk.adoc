...
Our official C SDK can be used from the command line, or from popular integrated development environments like Visual Studio Code, Eclipse, and CLion. To get started, download our C/{cpp} SDK and Examples, and take a look at our https://pip.raspberrypi.com/documents/RP-008276-DS[getting started] documentation. Or for a quick setup see the next section.

You can find documentation around the C/{cpp} SDK at:

https://pip.raspberrypi.com/documents/RP-008276-DS[Getting started with Raspberry Pi Pico-series]:: C/{cpp} development with Raspberry Pi Pico, Pico 2, and other Raspberry Pi microcontroller-based boards
...
https://pip.raspberrypi.com/documents/RP-009085-KB[Raspberry Pi Pico-series C/{cpp} SDK]:: Libraries and tools for C/{cpp} development on Raspberry Pi microcontrollers
