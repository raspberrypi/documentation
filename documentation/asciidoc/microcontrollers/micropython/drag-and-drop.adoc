...
* https://micropython.org/download/rp2-pico-w/rp2-pico-w-latest.uf2[Raspberry Pi Pico W] 
...
* https://datasheets.raspberrypi.com/XYZZY.uf2[Raspberry Pi Pico W] with Bluetooth LE support
