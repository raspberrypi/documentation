...
TIP: For instructions on how to use the debugger, see https://pip.raspberrypi.com/documents/RP-008276-DS[Getting Started with Pico-series Microcontrollers].
...
* Download the https://pip.raspberrypi.com/documents/RP-008273-DS[UF2 file]
