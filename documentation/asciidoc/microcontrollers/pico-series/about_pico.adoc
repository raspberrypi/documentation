...
* 26× multi-function GPIO pins including 4 that can be used for ADC
...
The Raspberry Pi Pico 2 comes as a castellated module allows soldering direct to carrier boards, while the Pico 2 _with headers_ comes with pre-soldered headers.
...
* Download https://datasheets.raspberrypi.com/pico/Pico-2-step.zip[STEP File]
* Download https://datasheets.raspberrypi.com/pico/Pico-2-Fritzing.fzpz[Fritzing Part] for Raspberry Pi Pico
