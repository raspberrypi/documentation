...
* Download https://datasheets.raspberrypi.org/rp2040/Minimal-KiCAD.zip[Minmal Viable Board] Design Files (KiCAD)
* Download https://datasheets.raspberrypi.org/rp2040/VGA-KiCAD.zip[VGA Carrier Board] Design Files (KiCAD)