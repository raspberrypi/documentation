...
The RP1 is a 12 × 12mm, 0.65mm-pitch BGA, “southbridge” which provides the majority of the I/O capabilities for xref:../computers/raspberry-pi-5.adoc[Raspberry Pi 5]. Access to peripherals from BCM2712 is done via the RP1 on Raspberry Pi 5. It provides:
