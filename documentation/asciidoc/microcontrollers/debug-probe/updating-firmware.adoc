...
. Push and hold the BOOTSEL button as you plug the Debug Probe into your computer, to mount a volume called RPI-RP2 (Pico) or RP2350 (Pico 2).
. Copy `debugprobe.uf2` onto the mounted volume. The volume will dismount automatically after the file finishes copying onto the device.
