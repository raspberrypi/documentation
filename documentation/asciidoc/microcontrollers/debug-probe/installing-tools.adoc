...
An OpenOCD Windows package is available https://github.com/raspberrypi/openocd/releases/tag/latest[for download] or via https://github.com/raspberrypi/pico-setup-windows/releases/tag/v0.5.1[Pico Windows Installer].
