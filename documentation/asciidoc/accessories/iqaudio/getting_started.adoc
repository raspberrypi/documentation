...
Use a small flat head screwdriver to attach your speaker to the screw terminals. For the additional push button, solder the buttons directly to the Codec Zero pads as indicated on GPIO pin 27 and Ground for the switch, and +5V and Ground for the LED, if necessary. 
