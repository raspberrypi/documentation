...
Raspberry Pi DigiAMP{plus} delivers direct connection to passive stereo speakers at up to 2x35W with variable output. Ideal for a Raspberry Pi-based Hi-Fi system.
