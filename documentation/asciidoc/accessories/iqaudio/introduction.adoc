...
Introducing our range of audio boards designed to bring high quality audio to your existing Hi-Fi or Raspberry Pi based equipment and projects. With 4 different HAT's (Hardware Attached on Top) to choose from all our boards will fit any Raspberry Pi utilising a 40-pin GPIO header.
