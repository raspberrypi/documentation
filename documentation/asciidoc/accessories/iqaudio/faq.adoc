...
To store the AlsaMixer setting, add the following at the command line:
...
Please ensure your Raspberry Pi power supply is able to deliver a minimum of 2.5 amps if you are powering via mini USB, and enable `max_usb_current`.
