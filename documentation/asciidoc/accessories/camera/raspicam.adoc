...
NOTE: The Quality value is NOT corresponding to typical JPEG Compression level values. A good allround value is -q 10. This is roughly equal to a JPEG Compression Level of 85. For details see https://stackoverflow.com/a/22722920/1331544
...
Another option is to output completely formatted YUV420 or RGB data using the xref:camera.adoc#raspiyuv[`raspiyuv`] application.
