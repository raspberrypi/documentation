...
To override the automatic camera detection, _Bullseye_ users will also need to delete the entry `camera_auto_detect=1` if present in the `config.txt` file. If you need to do edit this file then your Raspberry Pi will need to be rebooted. 
