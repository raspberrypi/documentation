...
NOTE: Camera Module 3 is compatible with all Raspberry Pi computers, with the exception of the 2016 launch version of Zero, which lacks the required FPC connector.
