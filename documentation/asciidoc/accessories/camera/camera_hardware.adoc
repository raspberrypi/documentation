...
Then, please follow the relevant setup instructions for xref:../computers/camera_software.adoc#libcamera-and-rpicam-apps[`rpicam-apps`], and the https://datasheets.raspberrypi.com/camera/picamera2-manual.pdf[Picamera2 Python library].
