...
. Format your drive using Raspberry Pi Imager. You can do this from your Raspberry Pi if you already have an SD card with a Raspberry Pi OS image.
...
.Schematics for the Raspberry Pi M.2 HAT+ M Key
image::images/m2-hat-plus-schematics.png[width="80%"]

Schematics are also available as a https://datasheets.raspberrypi.com/m2-hat-plus/raspberry-pi-m2-hat-plus-schematics[PDF].
