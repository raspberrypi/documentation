...
Both the M.2 HAT+ and M.2 HAT+ Compact conform to the https://pip.raspberrypi.com/documents/RP-008281-DS[Raspberry Pi HAT+ specification], which allows Raspberry Pi OS to automatically detect the HAT+ and any connected devices.
...
. xref:../computers/getting-started.adoc#imager-install[Install an operating system to your NVMe drive by using Raspberry Pi Imager]. You can do this from your Raspberry Pi if you already have an SD card with a Raspberry Pi OS image.
...
The schematics for the M.2 HAT+ are available as a https://pip.raspberrypi.com/documents/RP-008218-DS[PDF]

== Product brief

For more information about the M.2 HAT+ and M.2 HAT+ Compact, including mechanical specifications and operating environment limitations, see the https://pip.raspberrypi.com/documents/RP-009234-MM[product brief].
