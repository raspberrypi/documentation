...
The Raspberry Pi M.2 AI Kit bundles the xref:m2-hat-plus.adoc#m2-hat-plus[Raspberry Pi M.2 HAT+] with a Hailo AI acceleration module for use with Raspberry Pi 5. The kit contains the following:
...
* 13 tera-operations per second (TOPS) neural network inference accelerator built around the Hail-8L chip.
...
. For the best performance, we recommend using the AI Kit with the Raspberry Pi 5 Active Cooler. If you have an Active Cooler, install it before installing the AI Kit.
+
--
...
--
. Set the AI Kit on top of the spacers, and use the four remaining screws to secure the AI Kit in place.
+
--
