...
The Raspberry Pi M.2 AI Kit enables you to connect M.2 peripherals such as NVMe drives and other PCIe accessories to Raspberry Pi 5’s PCIe interface.
...
.Schematics for the Raspberry Pi AI Kit
image::images/ai-kit-schematics.png[width="80%"]

Schematics are also available as a https://datasheets.raspberrypi.com/ai-kit/raspberry-pi-ai-kit-schematics.pdf[PDF].

== Product brief

For more information about the AI Kit, including mechanical specifications and operating environment limitations, see the https://datasheets.raspberrypi.com/ai-kit/raspberry-pi-ai-kit.pdf[product brief].
