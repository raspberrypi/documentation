...
WARNING: The Raspberry Pi AI Kit is not yet supported with Raspberry Pi OS Trixie. To use the AI Kit, install or stay on Raspberry Pi OS Bookworm for now.
