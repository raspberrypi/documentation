...
.Mechanical diagram of AI HAT+; all measurements are approximate and in mm
image::images/aihat-plus-mechanical.png[width="60%"]

=== AI HAT+ 2 and heatsink specifications

The following image depicts the approximate physical dimensions of an AI HAT+ 2 in millimetres (mm). AI HAT+ is approximately 66 mm × 56.5 mm. The Hailo NPU is approximately 15 mm × 15 mm and the SDRAM is approximately 14.5mm × 10 mm.

.Mechanical diagram of AI HAT+ 2; all measurements are approximate and in mm
...
.Mechanical diagram of the heatsink for an AI HAT+ 2; all measurements are approximate and in mm
...
NOTE: Ensure that the push pins are undamaged and securely clipped onto the AI HAT+ 2 before use.
