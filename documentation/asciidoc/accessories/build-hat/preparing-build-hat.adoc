...
NOTE: Before starting to work with your Raspberry Pi Build HAT you should xref:getting-started.adoc#setting-up-your-raspberry-pi[set up] your Raspberry Pi, xref:getting-started.html#installing-the-operating-system[install] the latest version of the operating system using https://www.raspberrypi.org/downloads/[Raspberry Pi Imager].
...
[[powering-build-hat]]
[pdfwidth=75%]
.Powering the Build HAT using the Raspberry Pi Build HAT power supply.
