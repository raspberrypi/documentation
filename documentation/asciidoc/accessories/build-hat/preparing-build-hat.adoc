...
NOTE: Before starting to work with your Raspberry Pi Build HAT you should xref:../computers/getting-started.adoc#desktop-setup[set up] your Raspberry Pi, xref:../computers/getting-started.adoc#install[install] the latest version of the operating system using https://www.raspberrypi.com/downloads/[Raspberry Pi Imager].
