...
Connect an external power supply - the official Raspberry Pi Build HAT power supply is recommended.  You don’t need to connect a USB power supply to the Raspberry Pi as well, see <<powering-build-hat>> 
