...
It assumes that the Raspberry Pi is running the Raspberry Pi operating system (OS; Linux), and are fully up to date with the latest firmware and kernels.
****
