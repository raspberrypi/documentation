...
[discrete]
=== Are you running Raspberry Pi OS bullseye and the display turns off during the boot sequence?
...
Add a "#" to the line "" to disable the kms driver, so the line looks like this:
