...
Schematics and mechanical drawings for the Sense HAT and the Sense HAT V2 are available for download on the https://pip.raspberrypi.com/categories/676-raspberry-pi-sense-hat[Product Information Portal].
