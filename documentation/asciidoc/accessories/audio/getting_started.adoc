...
In this example, we are using Raspberry Pi OS Lite. Refer to our guide on xref:../computers/getting-started.adoc#install[installing Raspberry Pi OS] for more details.
