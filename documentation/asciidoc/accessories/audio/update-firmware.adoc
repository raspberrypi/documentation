...
NOTE: If the firmware fails to install correctly, an error screen will be displayed. In the first intance you should remove and reseat the HAT board and try flashing the firmware again.
