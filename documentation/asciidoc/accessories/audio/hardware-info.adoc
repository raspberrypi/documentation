...
* The barrel connector used for powering the DigiAMP{plus} is 2.5 mm ID, 5.5 mm OD, 11 mm.
...
(wire of max 1.6 mm in diameter).
...
image::images/pin_out_new.png[width="80%"]
