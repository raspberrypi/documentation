...
image::images/touch-display-2-whats-in-the-booooox.jpg[Parts included in the Touch Display 2 box]

== Install

.A Raspberry Pi connected to the Touch Display 2
image::images/touch-display-2-installation-diagram.png[Image of Raspberry Pi connected to the Touch Display]
