...
For optimal use of the memory available to the accelerator on the IMX500 sensor, add `--no-input-persistency` to the above commands. However, this will disable the input tensor being generated and returned to the application for debugging purposes.
