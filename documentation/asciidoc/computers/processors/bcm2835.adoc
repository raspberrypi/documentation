...
The BCM2835 is the Broadcom chip used in the Raspberry Pi 1 Models A, A+, B, B+, the Raspberry Pi Zero, the Raspberry Pi Zero W, and the Raspberry Pi Compute Module 1. Some details of the chip can be found in the https://pip.raspberrypi.com/documents/RP-008249-DS[peripheral specification] document. It contains a single-core ARM1176JZF-S processor.
