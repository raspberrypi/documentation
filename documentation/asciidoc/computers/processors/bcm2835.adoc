...
The BCM2835 is the Broadcom chip used in the Raspberry Pi Model A, B, B+, the Compute Module, and the Raspberry Pi Zero. Details of chip can be found in the https://datasheets.raspberrypi.org/bcm2835/bcm2835-peripherals.pdf[Peripheral specification] document.
