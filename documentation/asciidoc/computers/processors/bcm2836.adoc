...
IMPORTANT: This SoC is discontinued. Later Raspberry Pi 2 Model B revisions use a different SoC. For more information, see https://pip.raspberrypi.com/documents/RP-004577-PC[Raspberry Pi 2 Model B Product Change Note].
