...
Next, xref:linux_kernel.adoc#download-kernel-source[download your kernel sources]. In particular, ensure you have installed the xref:linux_kernel.adoc#native-build-sources[default native configuration] or xref:linux_kernel.adoc#cross-compiled-build-sources[default cross-compilation configuration].
