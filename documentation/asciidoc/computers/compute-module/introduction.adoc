...
* *Memory.* Compute Modules 4, 4S, and 5 offer different amounts of RAM; for details about the available options, see the dedicated sections for each Compute Module model on this page. Compute Modules 1, 3, and 3+ offer a fixed amount of RAM: Compute Module 1 (versions 1 and 3) offer 512 MB of RAM; Compute Modules 3 and 3+ offer 1 GB of RAM.
