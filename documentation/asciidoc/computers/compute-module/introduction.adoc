...
. Attach the silicone at the bottom of the cooler to the top of your CM5. Align the cutout in the cooler with the https://en.wikipedia.org/wiki/Hirose_U.FL[U.FL connector] and the on-board antenna (the trapezoid shaped area on the board next to the U.FL connector), ensuring both are visible through the cutout.
