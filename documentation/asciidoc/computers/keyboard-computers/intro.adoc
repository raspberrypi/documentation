...
** You have a Raspberry Pi 500+ and want to use a microSD card instead of the preinstalled M.2 SSD card as your boot media.
* Another computer running Windows, macOS, or Linux to prepare the microSD card.
* An internet connection and your Wi-Fi credentials (SSID and password).
...
* A micro HDMI cable to connect your monitor or display to your Raspberry Pi keyboard computer. Depending on your monitor, you might also need a micro-HDMI-to-HDMI cable.

[[step1-bootmedia]]
=== Step 1. Prepare your boot media

This is a necessary step only if your keyboard computer didn't come as part of a kit, or if you're setting up a Raspberry Pi 500+ and want to use a microSD card instead of the preinstalled M.2 SSD card.
...
* One or two displays as required. Both micro HDMI ports support up to 4K resolutions.
** If required, use a micro-HDMI-to-HDMI adapter and connect the larger (full HDMI) end of the cable to your display.
...
** If you're using an official xref:../computers/keyboard-computers.adoc[Raspberry Pi Monitor], you can connect speakers or headphones through the 3.5 mm audio jack at the back of the display.

[[step3-power]]
=== Step 3. Connect to power

Connect your Raspberry Pi keyboard computer to power and turn it on.

* On a *Raspberry Pi 400*, you turn on the keyboard computer using the following key combination: *Fn + F10*. The LED status light turns on and Raspberry Pi OS goes through its first-time boot setup process.
* On a *Raspberry Pi 500*, you turn on the keyboard computer using the dedicated power button in the top-right corner of the keyboard. The LED status light turns on and Raspberry Pi OS goes through its first-time boot setup process.
* On a *Raspberry Pi 500+*, you turn on the keyboard computer using the dedicated power button in the top-right corner of the keyboard. The keyboard lights up and Raspberry Pi OS goes through its first-time boot setup process.
...
After you've set up your keyboard computer with the above instructions, you can connect it to a network. This can be a wired (Ethernet) connection or a wireless (Wi-Fi) connection.
...
For detailed instructions, see xref:../computers/getting-started.adoc#step-4-connect-to-a-network-optional[Connect to a network] in the *Getting started* page.
