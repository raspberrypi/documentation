...
* *Power button.* Raspberry Pi 400 doesn't have a power button and is instead turned on and off with a combination of key presses (*Fn* + *F10*); both Raspberry Pi 500 and 500+ do have a power button.
