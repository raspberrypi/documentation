...
This section guides you through setting up your Raspberry Pi keyboard computer with a xref:../computers/os.adoc#os-installation[Raspberry Pi operating system (OS)], Wi-Fi, and peripherals (mouse and display) so that you can use it as a desktop computer. For more detailed guidance on setting up your Raspberry Pi, or if want to get started with a different setup, see xref:../computers/getting-started.adoc[Getting started].
