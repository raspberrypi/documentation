...
* Two displays with resolution up to 3840 × 2160 pixels (4K; Ultra HD) at a 30 Hz refresh rate, or resolution up to 1920 × 1080 pixels (Full HD) at a 60 Hz refresh rate.
* The display connected the HDMI0 port can support a resolution up to 3840 × 2160 pixels (4K; Ultra HD) at a 60 Hz refresh rate if you set the `hdmi_enable_4kp60=1` flag in xref:../computers/config_txt.adoc#what-is-config-txt[`/boot/firmware/config.txt`]; the second display still supports a resolution up to 3840 × 2160 pixels (4K; Ultra HD) at a 30 Hz refresh rate or 1920 × 1080 pixels (Full HD) at a 60 Hz refresh rate.
...
NOTE: Raspberry Pi OS Bookworm was the final version to support `raindrop` or `arandr` to configure display behaviours.
