...
If you do not use a monitor or keyboard to run your Raspberry Pi (known as headless), but you still need to do some wireless setup, there is a facility to enable wireless networking and SSH when xref:getting-started.adoc#advanced-options[creating an image].
