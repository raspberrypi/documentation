...
For Raspberry Pi 5, Compute Module 5, and Pi 500, `earlycon` output only appears on the 3-pin debug connector with the following configuration:
...
For Raspberry Pi 2, 3, 3+, Compute Module 3, and Compute Module 3+:
...
For Raspberry Pi 1, Zero models, and Compute Module 1:
