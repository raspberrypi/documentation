...
`vcgencmd get_config <config>`:: displays a specific config value, for example, `vcgencmd get_config arm_freq`
...
Conditional filters are covered in the xref:conditional.adoc[conditionals section].
