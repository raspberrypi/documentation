...
`decode_MPG2` is a licence key to allow hardware MPEG-2 decoding, for example, `decode_MPG2=0x12345678`.

=== `decode_WVC1`

`decode_WVC1` is a licence key to allow hardware VC-1 decoding, for example, `decode_WVC1=0x12345678`.
