...
On Raspberry Pi Zero, 1, 2 and 3, if HDMI output is disabled, the composite video output will be enabled.  Set `enable_tvout=0` to disable composite even if HDMI is not active.
