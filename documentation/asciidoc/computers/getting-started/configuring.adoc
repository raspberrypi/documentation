...
image::images/initial-setup/welcome_bt.png[alt="Welcome window of the configuration window.",width="80%"]
...
For more detailed instructions, see xref:configuration.adoc[Configuration].
...
[.left]
image::images/shutdown.png[alt="Shutdown from the desktop menu.",width="60%"]
.Desktop shutdown menu
[.left]
image::images/shutdown-menu.png[alt="Shutdown menu.",width="100%"]
--

You can then select from one of the following four options: Shutdown, Reboot, Lock Screen, and Logout, described in <<desktop-shutdown>>. If you don't want to choose one of these options, select the cross (*×*) icon in the top-right corner of the window instead.
