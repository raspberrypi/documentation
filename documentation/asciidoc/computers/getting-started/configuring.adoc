...
You need a monitor and a keyboard to navigate through the configuration wizard. A mouse is optional; you can use the *Tab* key to advance through the wizard.
...
image::images/shutdown.png[alt="Shutdown from the desktop menu.",width="30%"]

.Desktop shutdown menu
image::images/shutdown-menu.png[alt="Shutdown menu.",width="25%"]

You can use the mouse, or your keyboard cursor keys and *Enter* key, to select from one of the following options: *Shutdown*, *Reboot*, *Lock Screen*, and *Logout*, described in <<desktop-shutdown>>.
