...
NOTE: Plugging in a USB device to a Raspberry Pi Zero after it has booted can cause the voltage to drop enough that it causes the CPU to reboot. We therefore recommend that you use a powered USB hub, or that you connect USB devices before booting up.
