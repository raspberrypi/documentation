...
* Hardware interfaces for peripherals
...
* Choose *Use password authentication* to SSH into your Raspberry Pi over the network using the username and password you provided in the *Customisation > User* tab.
