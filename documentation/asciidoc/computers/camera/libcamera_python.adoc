...
Documentation about Picamera2 is available https://github.com/raspberrypi/picamera2[on GitHub] and in the https://pip.raspberrypi.com/documents/RP-008156-DS[Picamera2 manual].
