...
Beside the flags of xref:camera_software.adoc#preview-window-2[`--info-text`], you can provide any token that https://www.man7.org/linux/man-pages/man3/strftime.3.html[strftime] understands to display the current date and time.
