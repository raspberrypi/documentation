...
[NOTE]
====
From Raspberry Pi OS _Bookworm_ onwards, the camera capture applications are named ``rpicam-*``.
====
...
You can create your own `rpicam`-based applications with custom functionality to suit your own requirements. The https://github.com/raspberrypi/rpicam-apps[`rpicam-apps` source code] is freely available under a BSD-2-Clause licence.
