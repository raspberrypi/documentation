...
If you want to install a Package called "foobar" you can can use `apt search foobar` to search for the exact package name. It's likely these packages will be called `python-foobar` or `python3-foobar`.
