...
To boot via IPv6 you need an updated version of the firmware (for example, `start4.elf`) and the bootloader. Using the latest release of Raspberry Pi OS and the latest stable bootloader should be sufficient.
