...
DHCP Servers and clients identify themselves with variable length DUID (device unique ids). On the Raspberry Pi this is derived from the mac address (DUID_LL).
