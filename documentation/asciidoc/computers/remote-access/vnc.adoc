...
TIP: When enabled, you can access your WayVNC configuration at `/etc/wayvnc/`.
...
* your Raspberry Pi and the device running the VNC client, connected to the same network (for example, a home wireless network or VPN)
