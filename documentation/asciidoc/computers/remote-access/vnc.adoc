...
--
4. Click the "Options" button. Navigate to the "Input" tab. Tick the box next to "Show dot when no cursor" to ensure that you can always see a cursor in TigerVNC.
+
--
