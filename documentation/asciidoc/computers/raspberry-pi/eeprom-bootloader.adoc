...
You can change the URL of the JSON file used by the Raspberry Pi Imager application to get it to offer your own images by one of the following methods:
