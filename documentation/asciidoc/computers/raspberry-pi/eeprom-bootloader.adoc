...
Some Secure Boot configuration properties live in `config.txt`. For more information about those properties, see xref:config_txt.adoc#secure-boot-configuration-properties[Secure Boot configuration properties].
