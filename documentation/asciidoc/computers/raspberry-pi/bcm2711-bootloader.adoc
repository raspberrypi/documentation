...
[.whitepaper, title="Boot Security How To", subtitle="", link=https://pip.raspberrypi.com/categories/685-whitepapers-app-notes/documents/RP-003466-WP/Boot-Security-Howto.pdf]
****
This whitepaper describes how to implement secure boot on devices based on Raspberry Pi 4. For an overview of our approach to implementing secure boot implementation, please see the Raspberry Pi 4 https://pip.raspberrypi.com/categories/685-whitepapers-app-notes/documents/RP-004651-WP/Raspberry-Pi-4-Boot-Security.pdf[Boot Security whitepaper]. The secure boot system is intended for use with `buildroot` (or similar)-based OS images; using it with Raspberry Pi OS is not recommended or supported.
****
