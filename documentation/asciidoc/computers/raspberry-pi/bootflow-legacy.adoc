...
* The default pull for the GPIOs is defined on page 102 of the https://datasheets.raspberrypi.org/bcm2835/bcm2835-peripherals.pdf[ARM Peripherals datasheet]. If the value at boot time does not equal the default pull, then that boot mode is enabled.
