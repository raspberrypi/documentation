...
+
* Bit 1: sets the oscillator frequency to 19.2 MHz
...
This is passed to the operating system in the Device Tree, for example, `/proc/device-tree/axi/pcie@120000/rp1/ethernet@100000/local-mac-address`

`52-53`:: Wi-Fi MAC address
This is passed to the operating system in the Device Tree, for example, `/proc/device-tree/axi/mmc@1100000/wifi@1/local-mac-address`

`54-55`:: Bluetooth MAC address
This is passed to the operating system in the Device Tree, for example, `/proc/device-tree/soc/serial@7d50c000/bluetooth/local-bd-address`
