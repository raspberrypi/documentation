...
NOTE: The scripts and pre-compiled binaries used to create the `rpi-eeprom` package which is used to update the Raspberry Pi 4 bootloader and VLI USB controller EEPROMs are available https://github.com/raspberrypi/rpi-eeprom/[on GitHub].
