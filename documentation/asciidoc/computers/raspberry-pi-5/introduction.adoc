...
NOTE: If you are running your Raspberry Pi OS with a Desktop, you can press the power button twice in quick succession to shutdown. However, if you are running Raspberry Pi OS Lite in headless mode, pressing the power button a single time will initiate a shutdown.
