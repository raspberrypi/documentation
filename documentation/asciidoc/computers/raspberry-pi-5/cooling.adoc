...
Both of the available official accessories are actively managed by the Raspberry Pi firmware: at 50°C the fan will be turned on, at 60°C fan speed increases, at 67.5°C fan speed increases again, and finally at 75°C the fan steps up to full speed. Each level has a 5°C hysteresis so when the temperature drops 5°C below each threshold, the fan will spin down automatically.
