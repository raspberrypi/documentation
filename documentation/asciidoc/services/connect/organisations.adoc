...
If you already have devices associated with your personal account, you can transfer them all to the organisation that you just created. To do so:

. Select the *Transfer them all to this organisation?* link in the prompt.
. Confirm that you want to add the billable devices to your organisation's account by selecting *Transfer x devices* where "x" is the number of devices.
