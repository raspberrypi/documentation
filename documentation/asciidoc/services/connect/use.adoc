...
Connect lists all your linked devices on the *Devices* tab. For organisations, you can xref:connect.adoc#search-filter-devices[search and filter] this list, and add xref:connect.adoc#tag-devices[tags] to devices.
