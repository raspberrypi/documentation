...
Connect lists all your linked devices on the *Devices* tab. For organisations, you can search this list by device name or filter it by device characteristics.
