...
If you used Raspberry Pi Imager to install Raspberry Pi OS on your device, you might have already linked your device with your Connect account. For more information, see xref:../computers/getting-started.adoc#imager-install[Install using Imager].

If you want to use Raspberry Pi Connect with multiple users, see xref:../services/connect-for-organisations.adoc[Raspberrry Pi Connect for Organisations].
...
+
image::images/sign-in.png[alt="The Connect page, showing sign in selected from the Raspberry Pi Connect drop down menu.",width="100%"]
+
...
Connect lists all your linked devices on the *Devices* tab. For organisations, you can xref:../services/connect-for-organisations.adoc#search-filter-devices[search and filter] this list, and add xref:../services/connect-for-organisations.adoc#tag-devices[tags] to devices.
...
The connection methods available for each device are displayed as a grey badge below the name of the device. You can connect to your devices through the following methods:
...
Sign in to https://connect.raspberrypi.com[connect.raspberrypi.com] and go to the **Devices** tab.
...
image::images/screen-sharing-ended.png[alt="The screen sharing interface showing the message "Screen sharing session ended".",width="100%"]
...
image::images/screen-sharing-disabled.png[alt="The Connect interface, showing the Devices list, with the words "screen sharing" in strikethrough text to indicate that is has been disallowed.",width="100%"]
...
image::images/remote-shell.png[alt="Window showing an open connection using the the remote shell.",width="100%"]
...
image::images/remote-shell-notification.png[alt="The Connect interface, showing a remote shell notification at the top of the desktop window.",width="100%"]
