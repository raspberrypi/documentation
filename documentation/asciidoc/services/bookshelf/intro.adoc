...
The Bookshelf application in Raspberry Pi OS provides access to books and magazines published by Raspberry Pi Press. From Raspberry Pi OS _Trixie_ onwards, this also includes contributor-only titles.
