...
- **Headless** - A headless Raspberry Pi is one that does not have a display device, keyboard or mnouse plugged in. Access is usually by a network connection, using a remote access protocol like SSH or VNC.
