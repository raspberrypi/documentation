...
```
Note that although `wpa_passphrase` returns the `psk` value unquoted, the `wpa_supplicant.conf` file *requires* this value to be quoted. Else your Pi will just not connect to your network.
