...
If the voltage drops below 4.63v (+-5%), recent versions of the firmware will display a yellow lightning bolt symbol on the display to indicate a lack of power.
