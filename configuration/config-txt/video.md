...
Setting `hdmi_edid_file` to `1` will cause the GPU to read EDID data from the `edid.dat` file, located in the boot partition, instead of reading it from the monitor. More information is available [here](https://www.raspberrypi.org/phpBB3/viewtopic.php?p=173430#p173430).
...
To set a custom display mode not listed here, see [this thread](https://www.raspberrypi.org/phpBB3/viewtopic.php?f=29&t=24679).
...
Note that there is a [pixel clock limit](https://www.raspberrypi.org/phpBB3/viewtopic.php?f=26&t=20155&p=195443#p195443).The highest supported mode is 1920x1200 at 60Hz with reduced blanking.
