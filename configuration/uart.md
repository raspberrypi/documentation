...
There are other UART specific overlays in the folder. Refer to `/boot/overlays/README` for details on device tree overlays, or run `dtoverlay -h overlay-name` for description and usage information.
