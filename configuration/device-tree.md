__Device Trees, Overlays and Parameters__
=========================================

# Part 0: The TL;DR summary
...
[ This section borrows heavily from http://devicetree.org/Device_Tree_Usage ]
...
https://www.power.org/download.php?popup=1&file=7920&referer=/documentation/epapr-version-1-1/ (requires registration...)
